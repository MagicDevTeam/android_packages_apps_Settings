...
import com.android.settings.mm.quicksettings.QuickSettingsUtil;
...
public class QsSettings extends SettingsPreferenceFragment
    ...
    private boolean mAccessSystemUIRes = true;
    ...
    public PreferenceScreen refreshSettings()  {
        ...
        try {
            ...
            mAccessSystemUIRes = false;
            systemUiResources = null;
        }
        
        if (mAccessSystemUIRes && (systemUiResources != null)) {
            int intColor;
            String hexColor;
            ...
            if (intColor == -2) {
                ...
                mQuickTilesBgPressedColor.setSummary(getResources().getString(
            ...
            mDuplicateColumnsLandscape.setChecked(Settings.System.getInt(getActivity()
    ...
    public static class MyAlertDialogFragment extends DialogFragment {
        ...
        QsSettings getOwner() {
            return (QsSettings) getTargetFragment();
        }
