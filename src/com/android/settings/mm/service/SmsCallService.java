...
package com.android.settings.mm.service;
...
import com.android.internal.util.mm.QuietHoursHelper;
...
public class SmsCallService extends Service {
    ...
    private void startAlarm(Context context, String phoneNumber) {
        ...
        alarmDialog.setClass(context, com.android.settings.mm.service.BypassAlarm.class);
