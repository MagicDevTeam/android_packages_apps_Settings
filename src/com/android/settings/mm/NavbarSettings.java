...
import com.android.internal.util.mm.MagicActions;
...
public class NavbarSettings extends SettingsPreferenceFragment implements
    ...
    private void updateSettings() {
        ...
        boolean enableNavigationBar = Settings.System.getInt(getContentResolver(),
                ...
                MagicActions.isNavBarDefault(getActivity()) ? 1 : 0) == 1;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mMenuDisplayLocation) {
            ...
            if (!((Boolean) newValue) && !MagicActions.isPieEnabled(getActivity())
                    && MagicActions.isNavBarDefault(getActivity())) {
