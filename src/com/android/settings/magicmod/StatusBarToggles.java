...
public class StatusBarToggles extends SettingsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    private static final String PREF_TOGGLE_ORDER = "toggles_order";
    private static final String PREF_TOGGLE_RESET = "reset_toggles";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLayout = findPreference(PREF_TOGGLE_ORDER);

        mResetToggles = findPreference(PREF_TOGGLE_RESET);
