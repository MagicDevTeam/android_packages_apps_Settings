...
import com.android.settings.util.UtilCMDProcessor.CommandResult;
...
public class UtilHelpers {
    ...
    */
    ...
    public static boolean checkBusybox() {
        ...
        try {
            if (!new UtilCMDProcessor().su.runWaitFor("busybox mount").success()) {
    ...
    {
        final UtilCMDProcessor cmd = new UtilCMDProcessor();
    ...
    public static String readFileViaShell(String filePath, boolean useSu) {
        UtilCMDProcessor.CommandResult cr = null;
        if (useSu) {
            cr = new UtilCMDProcessor().su.runWaitFor("cat " + filePath);
        } else {
            cr = new UtilCMDProcessor().sh.runWaitFor("cat " + filePath);
        }
        if (cr.success())
            return cr.stdout;
        return null;
   ...
   public static void restartSystemUI() {
        new UtilCMDProcessor().su.run("pkill -TERM -f com.android.systemui");
    }

    public static void setSystemProp(String prop, String val) {
        new UtilCMDProcessor().su.run("setprop " + prop + " " + val);
    }
    ...
    private static String getSystemProp(String prop) {
        CommandResult cr = new UtilCMDProcessor().sh.runWaitFor("getprop " + prop);
        if (cr.success()) {
            return cr.stdout;
        } else {
            return null;
